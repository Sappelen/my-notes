...
Note that, once you change any other book data in Libiry, it will convert Calibre's book data file into a Libiry book data file! 
Tip: You can start by using Libiry on copies of some your book folders, to help you decide how you want to use Libiry.
